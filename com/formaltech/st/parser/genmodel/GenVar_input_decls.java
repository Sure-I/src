...
public class GenVar_input_decls {
    public static void enter(STParser.Var_input_declsContext ctx){
        try{
            Traversal.setFromParentEmf(ctx);
            Variable emf = (Variable)Traversal.getEmf(ctx);
            emf.setSection(VariableSection.VAR_INPUT);
        } catch(Exception exception){
            System.err.println("Error In enterVar_input_decls!!!");
        }
    }

    public static void exit(STParser.Var_input_declsContext ctx){ 
