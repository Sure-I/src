...
public class GenVar_external_decls {
    public static void enter(STParser.Var_external_declsContext ctx){
        try{
            Traversal.setFromParentEmf(ctx);
            Variable emf = (Variable)Traversal.getEmf(ctx);
            emf.setSection(VariableSection.VAR_EXTERNAL);
        } catch(Exception exception){
            System.err.println("Error In enterVar_external_decls!!!");
        }
    }

    public static void exit(STParser.Var_external_declsContext ctx){ 
