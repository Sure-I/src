...
public class STLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__161", "Multibit_part_access", "Direct_Variable", "Is_Retain", "Access_Spec", 
			"Unsigned_Int", "Signed_Int", "Binary_Int", "Octal_Int", "Hex_Int", "Char_Str", 
			"S_Byte_Char_Str", "D_Byte_Char_Str", "S_Byte_Char_Value", "D_Byte_Char_Value", 
			"Common_Char_Value", "Duration", "Fix_Point", "Interval", "Days", "Hours", 
			...
			"Identifier", "Letter", "Digit", "Bit", "Octal_Digit", "Hex_Digit", "Pragma", 
			"LINE_COMMENT", "MULTI_COMMENT_1", "MULTI_COMMENT_2", "WS", "EOL"
		};
	}
