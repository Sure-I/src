...
public class STLexer extends Lexer {
	...
	public static final int
		...
		MULTI_COMMENT_1=203, MULTI_COMMENT_2=204, WS=205, EOL=206;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"Multibit_part_access", "Numeric_Type_Name", "Int_Type_Name", "Sign_Int_Type_Name", 
			"Unsign_Int_Type_Name", "Real_Type_Name", "Char_Type_Name", "Time_Type_Name", 
			"Date_Type_Name", "Tod_Type_Name", "DT_Type_Name", "Bit_Str_Type_Name", 
			"Bool_Type_Name", "Multibits_Type_Name", "Direct_Variable", "Is_Retain", 
			"Access_Spec", "Real_Literal", "Unsigned_Int", "Signed_Int", "Binary_Int", 
			"Octal_Int", "Hex_Int", "Char_Str", "S_Byte_Char_Str", "D_Byte_Char_Str", 
			"S_Byte_Char_Value", "D_Byte_Char_Value", "Common_Char_Value", "Duration", 
			...
			"Day", "Date_And_Time", "Identifier", "Letter", "Digit", "Bit", "Octal_Digit", 
			"Hex_Digit", "Pragma", "LINE_COMMENT", "MULTI_COMMENT_1", "MULTI_COMMENT_2", 
			"WS", "EOL"
		};
	}
